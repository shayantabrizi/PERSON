...
public class TermQuery extends Query {
    ...
    class TermWeight extends Weight {
        ...
        TermWeight(IndexSearcher searcher, boolean needsScores, TermContext termStates, float boost)
                throws IOException {
        ...
        public Scorer scorer(LeafReaderContext context) throws IOException {
            ...
            if (termsEnum != null) {
                docs = termsEnum.postings(null, needsScores ? PostingsEnum.FREQS : PostingsEnum.NONE);
                assert docs != null;
            }
            LMStats lmStats = ((LMStats) stats);
            return new TermScorer(this, docs, similarity.simScorer(stats, context), lmStats.getCollectionProbability(), context.reader().getNormValues("content"), term, boost);
        }
     ...
     * @param boost
     */
    public TermQuery(Term t, float boost) {
    ...
    public Weight createWeight(IndexSearcher searcher, boolean needsScores, float boost) throws IOException {
        ...
        return new TermWeight(searcher, needsScores, termState, boost * this.boost);
    }
